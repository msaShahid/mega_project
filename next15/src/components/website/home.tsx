"use client";
import { Brain, Zap, BarChart3, MessageSquare, ArrowRight, Star } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-8 rounded-2xl border border-gray-700">
              ...
              <p className="text-gray-300 mb-6 text-lg leading-relaxed">
                The AI platform transformed our data analysis capabilities. We re now making decisions 10x faster with unprecedented accuracy.
              </p>
